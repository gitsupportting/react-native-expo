    ...
    componentDidMount() {
        ...
        this.setState({
            ...
            if (this.state.tempStock != '') {
                ...
                this.setState({
                    stockImage: this.state.tempStock.stockImage,
                    sLicenseImage: this.state.tempStock.sLicenseImage,
                    sInsuranceImage: this.state.tempStock.sInsuranceImage,
                    sAccessImage: this.state.tempStock.sAccessImage,
                    hasPortAccess: this.state.tempStock.hasPortAccess,
                    typeValue: this.state.tempStock.typeValue,
                    driverValue: this.state.tempStock.driverValue,
                    name: '',
                    currentLocation: '',
                    serialNumber: '',
                    licenseNumber: '',
                    ...
                    portAccessNumber: '',
                    accessDate: '',
                    name: this.state.tempStock.name,
                    currentLocation: this.state.tempStock.currentLocation,
                    serialNumber: this.state.tempStock.serialNumber,
                    licenseNumber: this.state.tempStock.licenseNumber,
                    licenseDate: this.state.tempStock.licenseDate,
                    insuranceNumber: this.state.tempStock.insuranceNumber,
                    expirationDate: this.state.tempStock.expirationDate,
                    portAccessNumber: this.state.tempStock.portAccessNumber,
                    accessDate: this.state.tempStock.accessDate,
                })
            }
        });
    }
                    ...
                    <View style={styles.card1}>
                        ...
                        <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                            {!this.state.buttonVisableSInsurance &&
                                ...
                                >
                                    <Ionicons name="ios-add-circle-outline" size={screenHeight * 0.04} color="#2684ff" />
                                    <Text style={{ fontSize: 18, color: '#2684ff', fontWeight: 'bold' }}> Insurance Pic </Text>
                                </TouchableOpacity>
                            }
                            {sInsuranceImage &&
                                <TouchableOpacity
